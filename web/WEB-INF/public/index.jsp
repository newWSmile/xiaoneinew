...
<body>
    ...
    <div class="main">
        ...
        <div class="banner1">
            <img style="width:719px; height: 306px;" src="/xiaoneinew/images/front/ay-0812-658-280.jpg">
        </div>
        <div class="intro">
        ...
        <div class="sea_friend">
            <span class="font2">寻找你的朋友</span><br/>
            <input type="text" name="search_friend">
            <img src="/xiaoneinew/images/front/sou.jpg"/><br/>
            <span class="font3">*校内网目前已开通<span class="font1">海外1500所大学</span>、 <span class="font1">国内3000所大学</span>、 <span class="font1">56000所中学</span>及 <span class="font1">85000家公司</span>。</span>
        </div>
        <%--建议--%>
        <div class="advice">
