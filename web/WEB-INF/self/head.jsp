...
<div class="head">
    <img src="/xiaoneinew/images/front/top1.gif" width="713px" />
    <img src="/xiaoneinew/images/front/top2.jpg" width="280px" />
    ...
    <ul class="home_navi">
        ...
        <li>搜索</li>
        <li style="width: 170px;"><input type="text" /><img src="/xiaoneinew/images/front/sou.jpg" /></li>
    </ul>
